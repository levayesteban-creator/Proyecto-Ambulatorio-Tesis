        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-4 shadow rounded-t-lg border-b border-gray-200">
                <div class="w-full md:w-1/3 relative">
                    <input v-model="search" type="text" placeholder="Buscar por nombre o cédula..." class="w-full pl-10 pr-4 py-2 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" />
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="patient in patients.data" :key="patient.id" class="hover:bg-blue-50/50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                ...
                                <Link :href="route('patients.edit', patient.id)" class="text-amber-700 hover:text-amber-900 bg-amber-50 px-3 py-1 rounded-md transition">Editar</Link>
